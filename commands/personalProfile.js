...
const timeConvertor = require('../utilities/timeConvertor.js');
...
exports.run = async (client, message, args) => {
    ...
    if (getUser[0] !== 'none' && getUser[0]) {
        ...
        if (data.rank_tier) {
            ...
            ctx.fillText(`Last Match: ${timeConvertor(recentMatches[0].start_time, recentMatches[0].duration)} `, canvas.width / 3, 167);
